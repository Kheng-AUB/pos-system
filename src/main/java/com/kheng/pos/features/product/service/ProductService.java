...
public interface ProductService {
    BaseApiResponse<ProductDto> createProduct(ProductDto productDto, UserProfileResponse userInfo);

    BaseApiResponse<ProductDto> updateProduct(Long productId, ProductDto productDto, UserProfileResponse userInfo);
