...
public interface AuthService {
    BaseApiResponse<AuthResponse> signup(SignUpRequest request) throws UserException;
    BaseApiResponse<AuthResponse> login(LoginRequest request) throws UserException;
}
